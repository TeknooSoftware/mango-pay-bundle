...
namespace UniAlteri\MangoPayBundle\Transcriber;

use MangoPay\Address;
use MangoPay\UserLegal;
use MangoPay\UserNatural;
use UniAlteri\MangoPayBundle\Exception\BadTypeException;
use UniAlteri\MangoPayBundle\Entity\Interfaces\User\AddressInterface;
use UniAlteri\MangoPayBundle\Entity\Interfaces\User\FullNaturalUserInterface;
use UniAlteri\MangoPayBundle\Entity\Interfaces\User\LegalUserInterface;
use UniAlteri\MangoPayBundle\Entity\Interfaces\User\NaturalUserInterface;
use UniAlteri\MangoPayBundle\Entity\Interfaces\User\UserInterface;

/**
 * Class UserTranscriber
 * @package UniAlteri\MangoPayBundle\Transcriber
 *
 * @copyright   Copyright (c) 2009-2015 Uni Alteri (http://uni-alteri.com)
 *
 * @link        http://teknoo.it/mangopay-bundle Project website
