...
phpmd:
	vendor/bin/phpmd --suffixes php src/ text codesize,design,unusedcode,controversial

phpcs:
	vendor/bin/phpcs --standard=PSR2 --extensions=php src/ --ignore=src/Teknoo/MangoPayBundle/StorageStrategy
